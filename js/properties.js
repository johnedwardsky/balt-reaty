...
const propertiesData = [
    ...
    },
    {
        "description": {
            ...
            "ru": "Уютная и светлая квартира в районе с развитой инфраструктурой. Кирпичный дом, обеспечивающий отличную тепло- и звукоизоляцию. В квартире выполнен косметический ремонт, заменены коммуникации. Прекрасный вариант как для жизни, так и для сдачи в аренду.",
